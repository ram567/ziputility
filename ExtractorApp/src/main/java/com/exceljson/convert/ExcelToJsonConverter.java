...
import com.exceljson.pojo.ExcelWorksheet;
...
/**
 * //TODO:https://github.com/nullpunkt/excel-to-json**/
//"dd.MM.yy"
public class ExcelToJsonConverter {
	...
	public ExcelWorkbook convert()
		...
		for (int i = 0; i < loopLimit; i++) {
			...
			//ArrayList<Object> rowData = tmp.getData();
	    		...
	    		if(j==0){
	    			...
	    			for(int z=0; z<header.size(); z++) {
		    			...
		    			if(cell!=null) {
		    				...
		    				hasValues = hasValues || value!=null;
		    			   	map.put(header.get(z), value);
		    			} else map.put(header.get(z), "");
		    		}
	    			tmp.getData().add(map);
